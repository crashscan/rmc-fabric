...
2. **PR 4 fixtures are immutable**
    ...
    - If a fixture must change, the PR description must explicitly justify why, and the change must be treated as a
      contract-impacting event, not routine refactor fallout.
