...
`lldp-observer` is an internal static target providing LLDP-backed topology observation. It is linked into
`network-observationd` and is not a separately installed runtime library.
