...
`netlink-monitor` is an internal static target providing low-level Linux network-state monitoring over netlink. It is
linked into `network-observationd` and is not a separately installed runtime library.
