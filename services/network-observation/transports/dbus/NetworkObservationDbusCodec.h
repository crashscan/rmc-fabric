...
[[nodiscard]] interop_contract::network_observation::LocalNetworkSnapshot fromVariantMapLocalSnapshot(
    const VariantMap &m);
...
[[nodiscard]] VariantMap encodeLocalSnapshot(
    const interop_contract::network_observation::LocalNetworkSnapshot &snapshot);
