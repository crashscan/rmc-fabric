...
public:
    ...
    [[nodiscard]] interop_contract::ClientResult<std::optional<contract::LocalInterfaceState> > tryGetInterface(
        const std::string &ifname);

    [[nodiscard]] interop_contract::ClientResult<std::vector<std::string> > tryGetRemoteCandidateMacs();

    [[nodiscard]] interop_contract::ClientResult<std::optional<contract::RemoteCandidate> > tryGetCandidateByMac(
