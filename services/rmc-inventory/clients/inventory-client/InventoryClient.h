...
public:
    ...
    [[nodiscard]] interop_contract::ClientResult<interop_contract::inventory::InventoryFields> tryGetField(
        const std::string &fieldName) const;

    [[nodiscard]] interop_contract::ClientResult<interop_contract::inventory::SourceStateMap>
    tryGetSourceStates() const;
